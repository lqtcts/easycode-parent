...
import com.encrypt.SystemConstants;
...
public class HttpClientUtil {
	...
	public static String sendPost(String auditurl, String dataString, String Token)   {
		CloseableHttpClient client = HttpClients.createDefault();
		System.out.println("pxene-msg"+dataString);
		try {
			HttpPost post = new HttpPost(auditurl);
			StringEntity strentity = new StringEntity(dataString, "UTF-8");
			...
			System.out.println("tencent-msg"+result);
			if (statusCode == 200) {
				return result;
