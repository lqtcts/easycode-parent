...
public class KafkaBidSink extends AbstractSink implements Configurable {
	
	private static final Log logger = LogFactory.getLog(KafkaBidSink.class);
    ...
    public Status process() throws EventDeliveryException {
    	...
    	try {
           ...
           KeyedMessage<String,String> data = new KeyedMessage<String, String>("newSettle", content);
           producer.send(data);
           tx.commit();
           return Status.READY;
       } catch(Exception e) {
