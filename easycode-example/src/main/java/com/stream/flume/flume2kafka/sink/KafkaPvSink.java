...
public class KafkaPvSink extends AbstractSink implements Configurable {
	
	private static final Log logger = LogFactory.getLog(KafkaPvSink.class);
    ...
    public Status process() throws EventDeliveryException {
    	...
    	try {
           ...
           KeyedMessage<String,String> data = new KeyedMessage<String, String>("newPv", content);
           producer.send(data);
           tx.commit();
           return Status.READY;
       } catch(Exception e) {
