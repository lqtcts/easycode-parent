...
public class KafkaLeaveDataSink extends AbstractSink implements Configurable {
	
	private static final Log logger = LogFactory.getLog(KafkaLeaveDataSink.class);
    ...
    public Status process() throws EventDeliveryException {
    	...
    	try {
           ...
           KeyedMessage<String,String> data = new KeyedMessage<String, String>("newLeaveData", content);
           producer.send(data);
           tx.commit();
           return Status.READY;
       } catch(Exception e) {
